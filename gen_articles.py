...
<style>*{{box-sizing:border-box;margin:0;padding:0}}body{{font-family:Pretendard,-apple-system,"Noto Sans KR",sans-serif;background:#f4f6fa;color:#222;max-width:760px;margin:0 auto;padding:0 16px 80px}}article{{background:#fff;border:1px solid #e6ebf4;border-radius:16px;padding:26px 22px;margin-top:18px}}h1{{font-size:1.35rem;line-height:1.5}}h2{{font-size:1.08rem;margin:26px 0 10px;padding-left:10px;border-left:4px solid #0b5fff}}p,li{{line-height:1.8;font-size:.96rem}}table{{width:100%;border-collapse:collapse;margin:14px 0;font-size:.9rem}}th,td{{border:1px solid #e2e8f2;padding:9px 10px;text-align:left}}th{{background:#f2f6ff;width:110px}}.lead{{background:#f2f6ff;border-radius:12px;padding:14px 16px;margin:16px 0}}.cta{{display:block;text-align:center;background:#0b5fff;color:#fff;border-radius:12px;padding:14px;margin:20px 0;text-decoration:none;font-weight:700}}.back{{display:inline-block;margin:18px 0 4px;color:#0b5fff;text-decoration:none}}.rel a{{display:block;padding:10px 4px;color:#0b5fff;text-decoration:none;border-bottom:1px solid #eef2f9;font-size:.92rem}}.muted{{color:#888;font-size:.84rem;margin-top:22px}}.hero{{width:100%;border-radius:12px;margin:14px 0 4px;display:block}}</style>
